...
/**
 * \brief utn_esUnNombreValido:	Verifica una cadena recibida como parametro para determinir si es un nombre valido.
 * \param char* cadena: Cadena a analizar.
 * \param int limite: Indica la cantidad de letras maxima de la cadena.
...
/**
 * \brief myGets: Verifica una cadena recibida como parametro para determinir si es un nombre valido.
 * \param char* cadena: Cadena a analizar.
